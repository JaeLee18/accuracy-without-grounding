"""
Shuffled-frames ablation for Qwen2-VL-7B-Instruct on Video-MME.
Uses pre-generated shuffled videos from prepare_ablation_videos.py.
"""
...
RESULTS_PATH = VDG_RESULTS_ROOT + "/full_study/qwen2vl_shuffled_results.json"
