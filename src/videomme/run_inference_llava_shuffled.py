"""
Shuffled-frames ablation for LLaVA-Video-7B-Qwen2 on Video-MME.
"""
...
RESULTS_PATH = VDG_RESULTS_ROOT + "/full_study/llava_shuffled_results.json"
ABLATION_DIR = VDG_RESULTS_ROOT + "/full_study/shuffled_videos"
CONDITION    = "shuffled"
    ...
    for sample in pbar:
        ...
        try:
            pred = run_single(tokenizer, model, image_processor,
                              video_path, sample["question"], sample["options"])
