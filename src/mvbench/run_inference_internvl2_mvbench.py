"""
InternVL2-8B inference on MVBench: original, CRF38, black screen.
All 3 conditions in one results file. Resume key: (question_id, condition).
Black condition requires original to be completed first (two-pass design).
...
RESULTS_PATH = VDG_RESULTS_ROOT + "/mvbench/internvl2_mvbench_results.json"
...
def main():
    ...
    pbar = tqdm(work, desc="InternVL2-MVBench")
