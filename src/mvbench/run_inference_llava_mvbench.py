"""
LLaVA-Video-7B-Qwen2 inference on MVBench: original, CRF38, black screen.
...
RESULTS_PATH = VDG_RESULTS_ROOT + "/mvbench/llava_mvbench_results.json"
...
def main():
    ...
    pbar = tqdm(work, desc="LLaVA-MVBench")
